...
$(document).ready(function(){
    ...
    $(".js_memberId").html(Request("id"));
    var str = Request("weixinName")+"("+Request("weixinid")+")";
    str = str.replace("undefined","");
    str = str.replace("undefined","");
    $(".js_memberWeixin").html(str);
    //加载select中的省份数据
        ...
        $.ajax({
            ...
            success:function(serverData){
                if(serverData["提示信息"] == "获取用户信息成功"){
                    ...
                    $(".serviceName").val(serverData["user"].serviceName);
    ...
    $(".settingSaveBtn").click(function(){
        ...
        obj.serviceName = $(".serviceName").val().trim();
        ...
        $.ajax({
            ...
            success:function(serverData){
                if(serverData["提示信息"] == "修改关注用户信息成功"){
                    location.href = "weixinMemberList.html";
                }
            }
        });
    });
