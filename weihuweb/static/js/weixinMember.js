        ...
        success:function(serverData){
           if(serverData["提示信息"] == "获得所有关注用户成功"){
               for(var i=0;i<8;i++){
                   ...
                   var tn1 = document.createTextNode(serverData["users"][i].id.substr(0,10));
                   var td2 = document.createElement("td");
//                   var tn2 = document.createTextNode(serverData["users"][i].id.substr(0,10));
                   var td3 = document.createElement("td");
//                   var tn3 = document.createTextNode(serverData["users"][i].id.substr(0,10));
                   var td4 = document.createElement("td");
//                   var tn4 = document.createTextNode(serverData["users"][i].id.substr(0,10));
